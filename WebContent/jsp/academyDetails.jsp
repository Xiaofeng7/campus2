...
<div id="articleExample" class="fade2">
	<div class="container">		
		<div class="row">
			<article>
				<h2><c:out value="${getAcademy.name }"></c:out></h2>
				<div class="article_bar">
					<ul>
						<li class="time"><c:out value="${getAcademy.time }"></c:out></li>
						<li class="time"><c:out value="${getAcademy.countId }"></c:out></li>
					</ul>
					<div class="article_tag">
						...
						<div class="article">
							<ul>
								<c:forEach var="i" items="${getAcademy.professionList }">
								<li>
									<p><c:out value="${i.name}"></c:out></p><br>
								</li>
								</c:forEach>
							</ul>
						</div>
