...
<div id="articleExample" class="fade2">
	<div class="container">		
		<div class="row">
			<article>
				<h2><c:out value="${getProfession.name }"></c:out></h2>
				<div class="article_bar">
					<ul>
						<li class="time"><c:out value="${getProfession.time }"></c:out></li>
						<li class="time"><c:out value="${getProfession.countId }"></c:out></li>
					</ul>
					<div class="article_tag">
						...
						<div class="article">
							<p><c:out value="${getProfession.content }"></c:out></p>
						</div>
					</div>
				</div>
			</article>
